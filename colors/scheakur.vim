...
call s:hi('Comment', '#04530d', '#ddf1dd')

call s:hi('Constant', '#a25a09')
call s:hi('Number', '#3d621e')
call s:hi('Identifier', '#0a7a7d')
call s:hi('Statement', '#0867bd', '', s:base)
call s:hi('String', '#0b3fad')
call s:hi('PreProc', '#a44734')
call s:hi('Conditional', '#aa3232')
call s:hi('Special', '#d32275')
" call s:hi('Operator', '#ef3d3d', '#ffe3e5')
call s:hi('Type', '#df3b12', '', s:base)
call s:hi('Repeat', '#1e7b47')
call s:hi('Function', '#4c1d84')
